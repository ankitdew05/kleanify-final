...
function Planchecker() {
  ...
  useEffect(() => {
    document.title = "Free Tool - Klaviyo Plan Checker";
  }, []);
  ...
  async function onSubmit({ name , email , apiKey, url , plan}) {
    setSpinner(true);
    console.warn(apiKey, url);
    let result = await fetch(`${baseURL}/planchecker/${JSON.parse(auth)._id}`, {
      method: "post",
      body: JSON.stringify({ apiKey, url , name , email , plan }),
      headers: {
      ...
      <div className="relative pt-32 pb-48 sm:pt-80 sm:pb-96 px-24 sm:px-64 overflow-hidden">
        ...
        <div className="flex flex-col items-center">
          ...
          >
            ...
            Free Tool - Klaviyo Plan Checker
            </div>
          </motion.div>
              ...
              <div className="p-24 sm:p-32 lg:p-40">
                ...
                >
                  ...
                  <Typography className="ml-2 md:text-xl leading-5">
                    (Go to Klaviyo Account {">>"} Settings {">>"} API Keys) to
                    get your <b>Klaviyo Private API Key.</b>
                  </Typography>
